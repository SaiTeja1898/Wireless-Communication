...
SabswithSNR=zeros(L,(3*K));
SabswoSNR=zeros(L,(3*K));
label=zeros(1,L);
...
datasetwoSNR=[Sabs label'];
writematrix(dataset,'datasetwithSNR.csv');
writematrix(datasetwoSNR,'datasetwoSNR.csv');
